...
{{-- <footer class="bg-dark py-5">
    <div class="container text-light text-center">
        <p class="font-primary fw-bolder display-5 mb-3">Karkhana</p>
                    ...
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M19.1 8.7c1.8 1.8 1.8 4.6 0 6.5l1 1c2.5-2.3 2.5-6.1 0-8.5zM18 9.8l-1 1c.5.7.5 1.6 0 2.3l1 1c1.2-1.2 1.2-3 0-4.3M14 1H4a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2m0 19H4V4h10z" />
                        </svg>
        ...
        <small class="font-secondary fw-light text-dark-50">&copy; by Karkhana, All rights reserved.</small>
    </div>
</footer> --}}
